...
function getAirBnbbda(ua) {
    ...
    var data = [
        ...
        {
            "key": "wh",
            "value": generateRandomHash()+"|"+generateRandomHash()
        },
        {
            "key": "enhanced_fp",
            "value": [
                ...
                },
                {
                    ...
                    "value": generateAudioFingerprint()
                },
                {
                ...
                },
                {
                    ...
                    "value": generateRandomHash5+" || zh-CN"
                },
                {
...
var ua = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36'
